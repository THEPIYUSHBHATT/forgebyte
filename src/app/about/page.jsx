  ...
  return (
    <>
      <div className="bg-black mt-12 md:mt-24 px-4">
        ...
        {/* about the company */}
        <section className="bg-black text-white px-6 md:px-16 py-40">
          {/* WHO WE ARE Section */}
          <div className="text-center mb-12">
            <span className="text-orange-400 bg-orange-900/20 px-4 py-2 rounded-full uppercase text-sm font-bold tracking-widest">
              Who We Are
            </span>
            <h2 className="text-3xl md:text-5xl font-bold mt-4">About our Company</h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-400 leading-relaxed text-4xl mt-4">
            ...
            <div className="w-full md:w-1/2">
              <div className="space-y-4">
                ...
                {['Our History', 'Our Mission', 'Our Vision'].map((title, index) => (
                  <div
                    key={index}
                    className="bg-[#232323] rounded-3xl flex justify-between items-center p-4 py-10 cursor-pointer hover:bg-gray-700 transition"
                  >
                    <span className="font-semibold text-2xl">
                      {`0${index + 1}. ${title}`}
                    </span>
                    <span className="bg-gray-600 text-gray-200 rounded-full h-6 w-6 flex justify-center items-center">
                      +
                    </span>
                  </div>
                ))}
